...
if choice==2:
    ...
    c1=conn.cursor()
    #c1=conn.cursor("('create table login(user_id varchar(100) primary key,passwd varchar(100),name varchar(100))')
...
if conn.is_connected():
    print('successfully connected')
c1=conn.cursor()    
c1.execute('create table old( v_customer_name varchar(40),gender varchar(20),v_phone_no int(50),v_items varchar(100),v_qty int(20),v_payment int(30)')
